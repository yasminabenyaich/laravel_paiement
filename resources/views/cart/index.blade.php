...
{{-- //une condition qui indique si on a min 1 produit = > else--}}
@if (Cart::count() > 0)
<div class="px-4 px-lg-0">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 p-5 bg-white rounded shadow-sm mb-5">
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            {{-- Le foreach = > Affiche tout le contenu du panier --}}
            ...
            <div class="row py-5 p-4 bg-white rounded shadow-sm">
                    ...
                    <div class="p-4">
                        ...
                        {{-- <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Sous-total </strong><strong>{{ $product->getPrice()}}</strong></li> --}}
 ...
 @else 
{{--Condition Si votre panier est vide  --}}
    <div class="col-md-12">
